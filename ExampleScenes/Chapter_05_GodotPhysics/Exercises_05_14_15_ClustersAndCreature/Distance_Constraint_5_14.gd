...
func initialize( node_1:PointMass_5_14, node_2:PointMass_5_14):
	point_1 = node_1
	point_2 = node_2
...
func _ready():
	if !point_1:
		point_1 = get_node(node_path_1) as PointMass_5_14
	if !point_2:
		point_2 = get_node(node_path_2) as PointMass_5_14
