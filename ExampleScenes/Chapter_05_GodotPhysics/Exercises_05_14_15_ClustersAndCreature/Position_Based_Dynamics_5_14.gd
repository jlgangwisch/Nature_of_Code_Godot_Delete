...
class_name Position_Based_Dynamics_5_14
...
func add_vertex( new_position:Vector2 = Vector2( 300.0, 300.0 ), is_static:bool = false, new_mass:float = 1.0 ) -> void :
	var new_point_mass := PointMass_5_14.new() as PointMass_5_14
...
func add_spring( node_index_1, node_index_2, new_compress, new_stretch  )->void:
	var link := Distance_Constraint_5_14.new()
	(link as Distance_Constraint_5_14).initialize( $verticles.get_child(node_index_1), $verticles.get_child(node_index_2) )
